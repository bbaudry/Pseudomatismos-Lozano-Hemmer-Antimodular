...
// called by the owner form
    ...
    procedure RenderSquare(Border:Integer);
    procedure TextureSquare(Border:Integer);
  end;
...
procedure TGLScene.RenderSquare(Border:Integer);
var
  X1,X2,Y1,Y2 : Integer;
begin
  X1:=Border;
...
procedure TGLScene.TextureSquare(Border:Integer);
const
  TX1 = 0; TX2 = 1;
  TY1 = 0; TY2 = 1;
var
