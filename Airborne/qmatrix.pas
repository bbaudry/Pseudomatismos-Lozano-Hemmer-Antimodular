...
// Quaternion/QMatrix/Euler conversion routines
function QuaternionToQMatrix(var Q:TQuaternion):TQMatrix;
function QMatrixToQuaternion(var M:TQMatrix):TQuaternion;
function EulersToQuaternion(Rx,Ry,Rz:Single):TQuaternion;
function EulersToQMatrix(Rx,Ry,Rz:Single):TQMatrix;
function QuaternionToEulers(Q:TQuaternion):TPoint3D;
function QMatrixToEulers(var M:TQMatrix):TPoint3D;

// Quaternion/QMatrix math routines
...
function  QMatrixMultiply(var M1,M2:TQMatrix):TQMatrix;
function  QMatrixMultiply34(A,B:TQMatrix):TQMatrix;
function  VectorQMatrixMult(var V:TVector;var M:TQMatrix):TVector;
function  Point3DMultQMatrix(Point:TPoint3D;M:TQMatrix):TPoint3D;
function  IdentityQMatrix:TQMatrix;
function  XRotationQMatrix(A:Single):TQMatrix;
function  YRotationQMatrix(A:Single):TQMatrix;
function  ZRotationQMatrix(A:Single):TQMatrix;
function  RxQMatrix(Angle:GLFloat):TQMatrix;
function  RyQMatrix(Angle:GLFloat):TQMatrix;
function  RzQMatrix(Angle:GLFloat):TQMatrix;
