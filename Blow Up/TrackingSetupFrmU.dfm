object TrackingSetupFrm: TTrackingSetupFrm
  ...
  object MainPanel: TPanel
    ...
    object DrawPanel: TPanel
      ...
      object AccumulatedRB: TRadioButton
        Left = 7
        Top = 63
        Width = 146
        Height = 17
        Caption = 'Accumulated background'
        TabOrder = 3
        TabStop = True
        OnClick = AccumulatedRBClick
      end
      ...
      object DrawForeGndPanel: TPanel
        ...
        object BlobsCB: TAprCheckBox
          ...
          TabOrder = 1
          TabStop = True
          OnClick = BlobsCBClick
        end
        object TimingInfoCB: TAprCheckBox
          Left = 21
          Top = 70
          Width = 76
          Height = 17
  ...
  object Panel3: TPanel
    ...
    object SupressIslandsCB: TAprCheckBox
      ...
      Width = 156
      Height = 17
      Caption = 'Suppress islands with area <'
      TabOrder = 8
      TabStop = True
    end
