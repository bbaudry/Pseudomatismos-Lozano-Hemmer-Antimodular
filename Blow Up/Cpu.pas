...
procedure ShowCpuUsage(Lines:TStrings);
...
var
  NtQuerySystemInformation : function(infoClass: DWORD;buffer: Pointer;
                     bufSize: DWORD;returnSize: TPDword): DWORD; stdcall = nil;
...
// get number of processors in the system
  ...
  with SysBaseInfo do begin
    Lines.Add('MaximumIncrement : '+IntToStr(uKeMaximumIncrement));
    Lines.Add('NumberOfPhysicalPages : '+IntToStr(uMmNumberOfPhysicalPages));
    Lines.Add('LowestPhysicalPage: : '+IntToStr(uMmLowestPhysicalPage));
    Lines.Add('HighestPhysicalPage : '+IntToStr(uMmHighestPhysicalPage));
    Lines.Add('AllocationGranularity : '+IntToStr(uAllocationGranularity));
    Lines.Add('ActiveProcessors : '+IntToStr(uKeActiveProcessors));
    Lines.Add('NumberProcessors : '+IntToStr(bKeNumberProcessors));
  end;
...
// Show Percentage
    Lines.Add('CPU Usage: 0.0 %'+FloatToStrF(dbIdleTime,ffFixed,9,1));
  end;
