...
procedure TCamSettingsFrm.Initialize(iShowVideo:Boolean);
var
  I,Min,Max  : Integer;
  Value      : Integer;
...
// events
  ...
  else ClientWidth:=456;
end;

procedure TCamSettingsFrm.FormDestroy(Sender: TObject);
begin
  if ShowVideo then begin
...
procedure TCamSettingsFrm.CamBtnClick(Sender: TObject);
begin
  Camera.ShowCameraPropertyPages;
end;

procedure TCamSettingsFrm.PinBtnClick(Sender: TObject);
begin
  Camera.ShowCameraPinPropertyPages;
end;

procedure TCamSettingsFrm.PaintBoxPaint(Sender: TObject);
begin
  PaintBox.Canvas.Draw(0,0,Bmp);
end;

procedure TCamSettingsFrm.DrawBmp;
begin
...
procedure TCamSettingsFrm.NewCameraFrame(Sender:TObject);
begin
  DrawBmp;
  PaintBox.Canvas.Draw(0,0,Bmp);
