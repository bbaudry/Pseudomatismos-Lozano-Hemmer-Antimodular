...
procedure TPointGreySettingsFrm.Initialize(iShowVideo:Boolean);
var
  I,Min,Max   : Integer;
  Value       : Integer;
...
procedure TPointGreySettingsFrm.FormDestroy(Sender: TObject);
begin
  if ShowVideo then begin
...
procedure TPointGreySettingsFrm.DrawBmp;
begin
...
procedure TPointGreySettingsFrm.NewCameraFrame(Sender:TObject);
begin
  DrawBmp;
...
procedure TPointGreySettingsFrm.PaintBoxPaint(Sender: TObject);
begin
  PaintBox.Canvas.Draw(0,0,Bmp);
end;
