...
- (void) loadSettings 
{
  ...
  self.lowThreshold = [ud integerForKey : kLowThreshold];
  self.highThreshold = [ud integerForKey : kHighThreshold];

  self.jumpD = [ud integerForKey : kJumpD];
  self.minArea = [ud integerForKey : kMinArea];
}  
...
- (void) saveSettings
{
  ...
  [ud setInteger : (int) lowThreshold forKey : kLowThreshold];
  [ud setInteger : (int) highThreshold forKey : kHighThreshold];

  [ud setInteger : (int) jumpD forKey : kJumpD];
  [ud setInteger : (int) minArea forKey : kMinArea];
}
