...
typedef struct RDColorSeasonStruct {
  float colorDivider;
  float scale;
  int scrollV;
  BOOL applyAlpha;
...
//typedef RDColorSeason RDColorSeasonArray[SEASONS+1];
...
@interface RDColor : Shader
{
  ...
  struct RDColorSeasonStruct season[SEASONS+1];
...
@property (nonatomic) float colorDivider;
@property (nonatomic) float scale;
@property int scrollV;
@property (nonatomic) BOOL applyAlpha;
