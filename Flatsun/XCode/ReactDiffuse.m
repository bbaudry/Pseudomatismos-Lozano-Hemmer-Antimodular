...
#define kReactDiffuseRz @"reactDiffuseRz"
...
- (id) init
{
  if (self = [super init]) {
    ...
    rz = 0;
 //   season = malloc(sizeof(ReactDiffuse)*(SEASONS+1));
  }
  return self;
}
...
{
  for (int s=0; s <= SEASONS; s++) {
    season[s].rdType = [settings intFromKey : kReactDiffuseType andTag : tag andSeason : s];
   
    season[s].alpha = [settings floatFromKey : kReactDiffuseAlpha  andTag : tag andSeason : s];
    season[s].speed = [settings intFromKey : kReactDiffuseSpeed andTag : tag andSeason : s];
  
    season[s].averages = [settings intFromKey : kReactDiffuseAverages andTag : tag andSeason : s];
    if (season[s].averages == 0) season[s].averages = 1;
  
    season[s].accScale = [settings intFromKey : kReactDiffuseAccScale andTag : tag andSeason : s];
    if (season[s].accScale == 0) season[s].accScale = 1;

    season[s].disturbScale = [settings floatFromKey : kReactDiffuseDisturbScale andTag : tag andSeason : s];
    season[s].tScale = [settings floatFromKey : kReactDiffuseTScale andTag : tag andSeason : s];
    season[s].minSpeed = [settings intFromKey : kReactDiffuseMinSpeed andTag : tag andSeason : s];
    season[s].visible = [settings intFromKey : kReactDiffuseVisible andTag : tag andSeason : s];
    season[s].rz = [settings floatFromKey : kReactDiffuseRz andTag : tag andSeason : s];
  }   
}  

- (void) copyVarsFromSeason : (int) s
{
  self.rdType = season[s].rdType;
  
  self.alpha = season[s].alpha;
  self.speed = season[s].speed;
  ...
  self.disturbScale = season[s].disturbScale;
...
{
  season[s].rdType = rdType;
  
  season[s].alpha = alpha;
  season[s].speed = speed;
  ...
  season[s].disturbScale = disturbScale;
...
- (void) saveSettings
{
  for (int s=0; s <= SEASONS; s++) {
    ...
    [settings setInt : season[s].rdType forKey : kReactDiffuseType andTag : tag andSeason : s];
    
    [settings setFloat : season[s].alpha forKey : kReactDiffuseAlpha andTag : tag andSeason : s];
    [settings setInt : season[s].speed forKey : kReactDiffuseSpeed andTag : tag andSeason : s];
  
    [settings setInt : season[s].averages forKey : kReactDiffuseAverages andTag : tag andSeason : s];
    [settings setInt : season[s].accScale forKey : kReactDiffuseAccScale andTag : tag andSeason : s];
  
    [settings setFloat : season[s].disturbScale forKey : kReactDiffuseDisturbScale andTag : tag andSeason : s];
    [settings setFloat : season[s].tScale forKey : kReactDiffuseTScale andTag : tag andSeason : s];
    [settings setInt :season[s].minSpeed forKey : kReactDiffuseMinSpeed andTag : tag andSeason : s];
    [settings setInt : (int) season[s].visible forKey : kReactDiffuseVisible andTag : tag andSeason : s];
    [settings setFloat : season[s].rz forKey : kReactDiffuseRz andTag : tag andSeason : s];
  }  
}
